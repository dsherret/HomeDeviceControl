...
namespace DeviceControl.Communication.PowerStatus.Client
{
    class Program
    {
        ...
        static void PrintUsage()
        {
            ...
            Console.WriteLine("Example: DeviceControl.Communication.PowerStatus.Client.exe 09E9E275-5C73-4FD0-B44B-D6890B176B75 true");
        }
    }
}
